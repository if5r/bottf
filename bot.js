...
if(!message.author.id === '484276031675695116') return;
...
m.sendMessage(args)
  ...
  client.on('message', msg => {
    ...
    msg.reply('سوف يقوم البوت بارسال الاومر لك بالخاص :white_check_mark:')
  });
...
const developers = ["484276031675695116","id"]
client.on('message', message => {
